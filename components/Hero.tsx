...
export default function Hero() {
  return (
    <section className="relative overflow-hidden bg-zinc-950">
      ...
      <div className="pointer-events-none absolute -left-32 bottom-20 h-96 w-96 rounded-full bg-white/[0.06]" />

      <div className="relative mx-auto max-w-6xl px-6 py-28">
        <div className="mx-auto max-w-3xl text-center">
          <p className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.04] px-4 py-1.5 text-sm text-white/70">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <a
              href="/about"
              className="inline-flex h-11 items-center justify-center rounded-lg border border-white/15 bg-white/[0.04] px-7 text-sm font-medium text-white/80 transition hover:bg-white/[0.08] focus:outline-none focus:ring-2 focus:ring-white/30"
            >
              About NextStore
            </a>
          </div>
