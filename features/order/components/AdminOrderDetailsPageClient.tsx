...
type AdminOrderDetailsPageClientProps = {
  orderId: number;
};

export function AdminOrderDetailsPageClient({
  orderId,
}: AdminOrderDetailsPageClientProps) {
            ...
            <div className="mt-5 space-y-3 text-sm">
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-zinc-700 bg-white px-3 py-2 text-sm font-medium capitalize text-black outline-none focus:border-zinc-400"
                >
